...
{literal}
<style>
    .zendesk-fail { color:red; }
    .zendesk-retry { color:orange; }
    .zendesk-pending { color:grey; }
    .zendesk-success { color: green; }
    .zendesk-na { color: grey; }
</style>
{/literal}
...
<tr>
    ...
    <th>{'Zendesk API'|i18n( 'design/admin/infocollector/collectionlist' )}</th>
    <th></th>
</tr>
...
<tr class="{$Collections.sequence}">
    ...
    {set zendesk_status=fetch('contact_us', 'zendesk_status', hash('informationcollection_id', $Collections.item.id))}
